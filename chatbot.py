...
class chatBot:
    def __init__(self):
        ...
        self.intruccion = """Eres un asistente que ayudara a los empleados del sector comercial con sus consultas en temas de ventas, 
                            ...
                            esto o que no se encuentren en nuestra base de datos."""
    ...
    def inicializar(self, functions_name):
        ...
        gem = gemai.GenerativeModel("models/gemini-1.5-flash", system_instruction=self.intruccion, tools=functions_name)
    ...
    def get_response(self, question):
        response = self.bot.send_message(question).text
        return response